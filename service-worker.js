const CACHE_NAME = 'lpu-calculator-cache-v1';
const urlsToCache = [
    './index.html',
    './manifest.json',
    './Lovely_Professional_University_logo.png', // <--- Added your PWA icon here
    ...
    // Add other static assets like images if you had them
];
